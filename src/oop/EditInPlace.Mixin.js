...
var EditInPlaceField=function(id,parent,value){
    this.id=id;
    this.value=value||'default value';
    this.parentElement=parent;
};

mixinHelper.mixin(EditInPlaceMixin,EditInPlaceField);

var EditInPlaceArea=function(id,parent,value){
    this.id=id;
    this.value=value||'default value';
    this.parentElement=parent;
};

mixinHelper.mixin(EditInPlaceMixin,EditInPlaceArea);
